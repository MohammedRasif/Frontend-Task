...
const CustomersSay = () => {
  ...
  return (
    <div className="relative">
      ...
      />
        <div className="relative bg-[#FBF7F2] py-5">
      {/* Main Content */}
      <div className="relative h-auto lg:h-[600px] px-4 md:px-16 lg:px-44">
        ...
        {/* Testimonial Content */}
        <div className="relative mt-10 h-auto lg:h-[420px] flex flex-col lg:flex-row items-center bg-yellow-500 shadow-lg rounded-lg overflow-hidden z-20">
          {/* Text Section */}
          <div className="text-black p-8 lg:px-24 lg:w-1/2 flex flex-col justify-between">
            ...
            <div className="relative flex items-center p-4 bg-yellow-500 rounded-lg">
              <div className="flex-grow">
                <div className="relative lg:-ml-5 mt-2 h-[2px] bg-red-500">
                  <div className="absolute right-0 top-0 h-[5px] w-8 bg-black"></div>
                </div>
              </div>
              <img
                src={testimonials[currentIndex].image}
                className="absolute lg:ml-[390px] lg:-mt-5 w-11 h-11 rounded-full lg:mb-10 border border-gray-300"
                alt="Customer"
              />
            </div>
          </div>
          ...
          {/* Video Section */}
          <div className="relative w-full lg:w-1/2 h-64 sm:h-80 lg:h-full aspect-w-16 aspect-h-9">
