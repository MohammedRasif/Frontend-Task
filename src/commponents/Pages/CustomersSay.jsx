  ...
  const testimonials = [
    {
      ...
      image:
        "https://res.cloudinary.com/dvubt5hiv/image/upload/v1731298251/zotnmc3dafrpzvwnrzdm.png",
      review:
    ...
    },
    {
      ...
      image:
        "https://res.cloudinary.com/dvubt5hiv/image/upload/v1727429594/samples/man-portrait.jpg",
      review:
            ...
            <div className="text-black p-8 lg:px-24 lg:w-1/2 flex flex-col justify-between order-2 lg:order-1">
              ...
              <div className="relative flex items-center p-4 bg-yellow-500 rounded-lg">
                ...
                <img
                  ...
                  className="absolute lg:ml-[340px] lg:-mt-5 -mt-20 ml-[155px] w-11 h-11 rounded-full lg:mb-10 border border-gray-300"
                  alt="Customer"
                />
              </div>
            </div>
