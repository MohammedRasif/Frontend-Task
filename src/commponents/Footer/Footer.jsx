...
const Footer = () => {
    return (
        ...
        style={{
          backgroundImage: 'url(https://i.ibb.co/r2y1ndr/f909efb883f56845dcebe7cdc85a607c.jpg)',
        }}
      >
        {/* Overlay */}
        ...
        <div className="relative z-10 text-center lg:pt-20">
          ...
          <div className="flex justify-center gap-4 mt-8">
            <a href="#" className="text-blue-500 text-2xl border rounded-full p-2"><FaFacebook /></a> 
            <a href="#" className="text-white text-2xl border rounded-full p-2"><FaXTwitter /></a> {/* Twitter Icon */}
            <a href="#" className="text-yellow-400 text-2xl border rounded-full p-2"><FaInstagram />
            </a> {/* Instagram Icon */}
            <a href="#" className="text-blue-500 text-2xl border rounded-full p-2"><FaLinkedinIn />
            </a> {/* LinkedIn Icon */}
          </div>
